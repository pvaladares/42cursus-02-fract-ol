...
/*   Updated: 2022/07/29 23:12:53 by pvaladar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	x_cursor_start		: x coordinate of the cursor when program was started
	y_cursor_start		: y coordinate of the cursor when program was started
	x_cursor_saved		: x coordinate of the cursor last saved during runtime
	y_cursor_saved		: y coordinate of the cursor last saved during runtime
*/
